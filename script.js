        ...
        res.insertAdjacentHTML("afterbegin", `
                <div class="tasks-res" id="${item.id}">
                    <form class="tasks">
                        ...
                        <button type="submit" class="button-edit hidden" onClick="Update(${item.id})" ><i class="fa-solid fa-right-left" style="color: #494c6b;"></i></button>
                    ...
                    <div class="tasks-btn">
                    <button class="button-toggle" onClick='toggleForm(${item.id})'><i class="fa-solid fa-pen" style="color: #494c6b;"></i></button>
                    <button class="button-cross" onClick='Delete(${item.id})' />
                    <button class="cancel hidden" onClick=Cancelar(${item.id})><i class="fa-solid fa-circle-xmark" style="color: #494c6b;"></i></button>
                    </div>
                </div>`
        )
    });
